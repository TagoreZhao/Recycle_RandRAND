...
%WRITE_VARVISC_SCHUR_ALL_RESULTS  Master CSV, one row per case and timestep.
    ...
    diagnostics = {'kappa','lambda_min','lambda_max','ReldiffF', ...
        'RelInitdiffF','InvRelDiff','coupling_change','A_change','D_change', ...
        'pressure_schur_change','nu_contrast','backslash_relres', ...
        'vel_recovery_err','symmetry_res','chol_flag','nC','nS'};
