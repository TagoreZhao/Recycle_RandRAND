...
%RUN_ALL_TESTS  Run all variable-viscosity Schur assertion scripts.
    ...
    tests={'test_varvisc_schur_correctness','test_varvisc_schur_pin', ...
        ...
        'test_varvisc_schur_hard_case','test_varvisc_schur_extract', ...
        'test_varvisc_schur_extreme_eigenvalues', ...
        'test_varvisc_schur_adaptive_tuning', ...
        'test_varvisc_schur_gaussian_refresh','test_varvisc_schur_augmentation', ...
        'test_varvisc_schur_augmented_workflow','test_varvisc_schur_two_stage_augmentation'};
    failed={}; t=tic;
    for i=1:numel(tests)
        fprintf('\n================ %s ================\n',tests{i});
