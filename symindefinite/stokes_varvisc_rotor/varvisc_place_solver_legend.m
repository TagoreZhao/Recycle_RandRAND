function lgd = varvisc_place_solver_legend(parent, h, labels, opts)
...
%   varvisc_plot_solver_curves and LABELS the matching text.
%
...
%
%   See also: varvisc_plot_solver_curves, save_varvisc_figure.

    if nargin < 4 || isempty(opts), opts = varvisc_fig_defaults(); end
