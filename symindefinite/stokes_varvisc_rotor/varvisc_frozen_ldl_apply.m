function X = varvisc_frozen_ldl_apply(ctx, B)
%FROZEN_LDL_APPLY  Apply the frozen inverse: X = K_ref^{-1} B, one or many columns.
%
%   X = FROZEN_LDL_APPLY(CTX, B)   CTX from varvisc_frozen_ldl_context.
%
...
%
%   See also: varvisc_frozen_ldl_context, varvisc_build_lowrank_sketch_V.
