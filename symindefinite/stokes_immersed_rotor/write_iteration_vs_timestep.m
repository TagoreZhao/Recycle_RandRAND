function write_iteration_vs_timestep(out_dir, stats, opts)
...
%   See also: plot_solver_curves, place_solver_legend.
    ...
    ax = nexttile(tl);
    [h, legLabels] = plot_solver_curves(ax, (1:ns)', stats, 'time step n', opts);
    ...
    save_benchmark_figure(fh, fullfile(out_dir, [stats.case_name '.png']), opts);
end
