function ctx = frozen_ldl_context(K)
...
%   frozen_ldl_apply) and the matrix ITSELF, which is what makes the difference
...
%   stokes_immersed_rotor_woodbury/woodbury_apply_ref.m, which frozen_ldl_apply
...
%     .L .dD .perm .Sscale      the frozen factors (apply: frozen_ldl_apply)
...
%
%   See also: frozen_ldl_apply, build_lowrank_sketch_V, woodbury_apply_ref.
